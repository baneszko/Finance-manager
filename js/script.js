...
const createNewTransaction = () => {
    ...
    <button class="delete" onclick="deleteTransaction(${ID})"><i class="ti ti-x"></i></button></p>`;
...
const checkCategory = (transaction) => {
	switch (transaction) {
		case "[ + ] Przychód":
			categoryIcon = '<i class="ti ti-coin"></i>';
			break;
		case "[ - ] Zakupy":
			categoryIcon = '<i class="ti ti-shopping-cart-off"></i>';
			break;
		case "[ - ] Jedzenie":
